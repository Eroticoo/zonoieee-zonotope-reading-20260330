...
![图1：预测-更新-一致性递推](__PUBLIC_IMAGE_PREFIX__/system_model.png)
...
![图3：Algorithm 1，三步递推算法](__PUBLIC_IMAGE_PREFIX__/algorithm_1.png)
...
![图4：Assumption 1，不变量假设](__PUBLIC_IMAGE_PREFIX__/assumption_1.png)
...
![图5：Lemma 1，均值定理型线性表示](__PUBLIC_IMAGE_PREFIX__/lemma_1.png)
...
![图6：Proposition 3，非线性测量的均值定理更新](__PUBLIC_IMAGE_PREFIX__/proposition_3.png)
...
![图7：Proposition 4，一阶Taylor更新公式](__PUBLIC_IMAGE_PREFIX__/proposition_4.png)
...
![图8：Corollary 1，均值定理型一致性步骤](__PUBLIC_IMAGE_PREFIX__/corollary_1.png)

对 $C^2$ 情形，Corollary 2 则把二阶余项写进集合 $R$，得到 Taylor 版本的一致性收缩公式。

![图9：Corollary 2，一阶Taylor型一致性步骤](__PUBLIC_IMAGE_PREFIX__/corollary_2.png)
...
![图10：Figure 4，先验可行域对一致性步骤的帮助](__PUBLIC_IMAGE_PREFIX__/figure_4.png)
...
![图11：Figure 5，CZMV-like 方法的半径比较](__PUBLIC_IMAGE_PREFIX__/figure_5.png)
...
![图12：Figure 6，CZFO-like 方法的半径比较](__PUBLIC_IMAGE_PREFIX__/figure_6.png)
...
![图13：Table 3，平均半径比 ARR 汇总](__PUBLIC_IMAGE_PREFIX__/table_3.png)
