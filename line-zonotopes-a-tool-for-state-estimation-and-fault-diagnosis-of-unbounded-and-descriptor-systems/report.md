...
![图1：描述符系统模型与问题定义](__PUBLIC_IMAGE_PREFIX__/system_model.png)
...
![图2：Definition 2，线Zonotope定义](__PUBLIC_IMAGE_PREFIX__/definition_2.png)
...
![图3：Proposition 1 的命题陈述，LZ 对无界集合的表达能力](__PUBLIC_IMAGE_PREFIX__/proposition_1.png)

上图直接给出了 Proposition 1 的命题陈述。虽然这条命题本身非常紧凑，但它不是一个边角结论，而是 LZ 理论成立的最关键论据之一：$\mathbb{R}^n$、strip 和 hyperplane 都是 LZ。特别是 strip
...
![图4：Algorithm 1，线消除过程](__PUBLIC_IMAGE_PREFIX__/algorithm_1.png)
...
![图5：Lemma 1，描述符系统预测包络](__PUBLIC_IMAGE_PREFIX__/lemma_1.png)
...
![图6：Theorem 1，AFD 中的分离输入判据](__PUBLIC_IMAGE_PREFIX__/theorem_1.png)
...
![图7：Fig. 2，状态估计半径与投影比较](__PUBLIC_IMAGE_PREFIX__/figure_2.png)
...
![图8：Table 1，输出可达管交集结果](__PUBLIC_IMAGE_PREFIX__/table_1.png)
...
![图9：Fig. 3，不同模型下的输出可达管投影](__PUBLIC_IMAGE_PREFIX__/figure_3.png)
