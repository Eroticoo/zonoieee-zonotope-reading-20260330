...
![论文抬头：标题与作者](https://cdn.jsdelivr.net/gh/Eroticoo/zonoieee-zonotope-reading-20260330@f481fedf93d2e2510420e3ad3bb00c75869f3516/joint-state-and-parameter-estimation-based-on-constrained/images/header.png)

- 关键词：受约束Zonotope；联合状态与参数估计；非线性状态估计；参数辨识；广义交集；集合计算
- DOI / 论文链接：https://doi.org/10.1016/j.automatica.2022.110425

**系列时间线与本文位置：** 若按 Rego 这组论文的主线递进来排，顺序是：`2020 年 Automatica 基础 nonlinear state estimation -> 2021 年 Automatica invariants consistency -> 2022 年 Automatica 本文 -> 2025 年 3 月 31 日 arXiv 多面体松弛方法`。另有 `2025 年 5 月 23 日在线发表的 Automatica《Line zonotopes》` 作为描述符/无界系统分支。本文是主线第三步，开始把前两篇中的集合递推思想推广到状态与参数联合估计。

## 1. 研究背景、问题定义与核心思路
### 1.1 研究动机与关键挑战

在主线里，本文位于 2020 和 2021 两篇 Automatica 之后。它保留了前两篇关于 constrained zonotope 传播、广义交集和递推收紧的核心思路，但把“只估状态”升级为“状态与参数一起估”，因此研究焦点从非线性包络传播本身，转向如何在增广空间里保持 state-parameter 几何依赖。
...
![图1：联合状态-参数框架与线性递推](https://cdn.jsdelivr.net/gh/Eroticoo/zonoieee-zonotope-reading-20260330@f481fedf93d2e2510420e3ad3bb00c75869f3516/joint-state-and-parameter-estimation-based-on-constrained/images/joint_framework.png)
...
![图2：Definition 1，受约束Zonotope定义](https://cdn.jsdelivr.net/gh/Eroticoo/zonoieee-zonotope-reading-20260330@f481fedf93d2e2510420e3ad3bb00c75869f3516/joint-state-and-parameter-estimation-based-on-constrained/images/definition_1.png)
...
![图3：Theorem 1，区间Jacobian乘集合的包络算子](https://cdn.jsdelivr.net/gh/Eroticoo/zonoieee-zonotope-reading-20260330@f481fedf93d2e2510420e3ad3bb00c75869f3516/joint-state-and-parameter-estimation-based-on-constrained/images/theorem_1.png)
...
![图4：Proposition 1，非线性联合预测的核心命题](https://cdn.jsdelivr.net/gh/Eroticoo/zonoieee-zonotope-reading-20260330@f481fedf93d2e2510420e3ad3bb00c75869f3516/joint-state-and-parameter-estimation-based-on-constrained/images/proposition_1.png)
...
![图5：Corollary 1，联合预测的 CG-rep 形式](https://cdn.jsdelivr.net/gh/Eroticoo/zonoieee-zonotope-reading-20260330@f481fedf93d2e2510420e3ad3bb00c75869f3516/joint-state-and-parameter-estimation-based-on-constrained/images/corollary_1.png)
...
![图6：Fig. 1，线性系统中状态半径与参数半径比较](https://cdn.jsdelivr.net/gh/Eroticoo/zonoieee-zonotope-reading-20260330@f481fedf93d2e2510420e3ad3bb00c75869f3516/joint-state-and-parameter-estimation-based-on-constrained/images/figure_1.png)
...
![图7：Fig. 2，非线性系统在多个时刻的联合集合比较](https://cdn.jsdelivr.net/gh/Eroticoo/zonoieee-zonotope-reading-20260330@f481fedf93d2e2510420e3ad3bb00c75869f3516/joint-state-and-parameter-estimation-based-on-constrained/images/figure_2.png)
...
![图8：Fig. 3，非线性系统中状态面积与参数半径比较](https://cdn.jsdelivr.net/gh/Eroticoo/zonoieee-zonotope-reading-20260330@f481fedf93d2e2510420e3ad3bb00c75869f3516/joint-state-and-parameter-estimation-based-on-constrained/images/figure_3.png)
